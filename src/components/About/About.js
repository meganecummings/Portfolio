            ...
            <div className="about col-side">
                ...
                <div class="mt-4 pt-2">
                    <a href="https://github.com/meganecummings" target="_blank"
                        class="btn btn-outline-custom btn-round"><i class="fab fa-github-alt fa-i"></i>Github</a>
                    <a href={resume} target="_blank"
                        class="btn btn-outline-custom btn-round"><i class="far fa-id-badge fa-i"></i>Resume</a>
                </div>
                <br/>
                <h4>Technologies</h4>
                <p> In only 4 short months of programming, I've learned over 12 various languages and frameworks. I've listed some that I've been experimenting with more recently...</p>
                <br/>
                <Container hover>
                    <Row>
